...
//	 i2c1.writeByteSync(MCP23017_ADDRESS_0x21, IODIRA, 0xFF); //Set all of bank A to inputs 
//	 i2c1.writeByteSync(MCP23017_ADDRESS_0x21, IODIRB, 0xFF); //Set all of bank B to inputs		 
...
module.exports.writePin = function (address, gpio, pin, newPinValue) {
	  ...
	  if(oldPinValue === newPinValue+""){
	     ...
	     return (newPinValue===1) ? true : false;
	  }
...
module.exports.switchPin = function (address, gpio, pin) {
	  ...
	  console.log("0x22-GP"+gpio+pin, isOn, new Date());
